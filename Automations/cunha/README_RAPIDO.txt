...
Para iniciar coleta automática diária às 23:00:
    ...
    3. python Automations/cunha/cunhaLabV2.py --daemon
...
Executar coleta agora (sem esperar 23h):
    python Automations/cunha/cunhaLabV2.py

Forçar reprocessamento:
    python Automations/cunha/cunhaLabV2.py --force

Aumentar velocidade (mais threads):
    python Automations/cunha/cunhaLabV2.py --threads=24
...
Arquivo: relatorio_completo_laboratorios_gralab.xlsx

Abas:
  ✓ Dados Completos - Todos os 440 labs com preços
...
Erro de chaves → Verifique arquivo .env
