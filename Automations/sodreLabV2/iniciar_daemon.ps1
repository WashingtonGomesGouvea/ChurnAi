# ================================================================================
#              SCRIPT DE INICIALIZAÇÃO - COLETA AUTOMÁTICA SODRE
# ================================================================================
#
...
Write-Host "             INICIANDO MODO DAEMON - SODRE" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
...
if ($Threads -eq 0) {
    ...
    python Automations/cunha/sodreLabV2.py --daemon
} else {
    # Usar threads personalizadas
    python Automations/cunha/sodreLabV2.py --daemon --threads=$Threads
}
